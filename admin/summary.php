...
function SubjectDivWiseFeedback($fbresults, $teacherresults, $subjectresults,$subjectid,$teacherid,$divisionid){
    ...
    $pdf->Cell(0,18, 'Overall Average :'.round(($totalsum/(int)12),2)."%", 'T',1,'C');
    ...
    $pdf->SetFont('Arial','',12);
    $pdf->Cell(0,9, strtoupper($teacherresults['teacher_name'])."                          Head Of Department                          Principal, RGIT", 0,1,'C');
    
    $pdf->SetFont('Arial','',8);
    $pdf->Cell(0,6, "This feedback is for process of continuous improvement. Faculty member can make action plan based on this feedback.", 0,1,'L');
    
    $pdf->SetFont('Arial','',8);
    $pdf->Cell(0,6,"MCT_RGIT_IQAC/feedback/odd_semester/2021", 0,1,'L');
